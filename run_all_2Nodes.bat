...
start cmd /k "cd /d %BASEDIR% && java -cp target/classes;%BASEDIR%\lib\* components.node.EdgeNode node1"
start cmd /k "cd /d %BASEDIR% && java -cp target/classes;%BASEDIR%\lib\* components.node.EdgeNode node2"
