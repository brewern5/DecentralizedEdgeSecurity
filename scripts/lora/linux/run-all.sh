...
LORA_DIR="${ROOT_DIR}/lora-simulation"
CP="${CORE_DIR}/target/classes:${LORA_DIR}/target/classes:${CORE_DIR}/target/dependency/*:${LORA_DIR}/target/dependency/*"
COMMON_JAVA_OPTS="-Ddes.transport.profile=lora -Dtransport.mode=LORA -Dlora.config.path=${ROOT_DIR}/config/lora/lora_simulation/loraConfig.properties"
