...
public abstract class PacketHandler {
    ...
    protected HandlerResponse packetResponse;
    
    // Tears the packet apart and seperates the head from the body
    public HandlerResponse handle(CoordinatorPacket recievedPacket){
        ...
        if(payload.trim().isEmpty()){
            return new HandlerResponse(false, new Exception("No payload Sent."), "Error handling payload for PacketType " + recievedPacket.getPacketType());
        }
    ...
    public abstract HandlerResponse process();
