...
public class EdgeServer {
    ...
    private static Socket edgeModule;
    ...
    public static void init() {
        ...
        port = config.generatePort("edgeServer.port");

        try {
            edgeModule = new Socket(IP, 4001);

            PrintWriter output = new PrintWriter(edgeModule.getOutputStream(), true);
            BufferedReader input = new BufferedReader(new InputStreamReader(edgeModule.getInputStream()));
